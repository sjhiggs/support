...
../../../../ca/scripts/cert-client.sh --cn=myamquser
...
cat /tmp/ca-data/certs/myamquser.pem /tmp/ca-data/issuing/ca.issuing.pem > /tmp/ca-data/certs/myamquser.combined.pem
openssl pkcs12 -export -in /tmp/ca-data/certs/myamquser.combined.pem -inkey /tmp/ca-data/certs/myamquser.key -out /tmp/ca-data/certs/myamquser.p12 -passin pass:foobar -passout pass:foobar
